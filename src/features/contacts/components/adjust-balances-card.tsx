...
export default function AdjustBalancesCard({ adjustableAmount, currency, onAdjustClick }: AdjustBalancesCardProps) {
  return (
    <div className="bg-[#E4F2EB] border-[1.5px] border-[#0B683A26] rounded-[20px] p-4 flex items-center gap-3.5 shadow-[0px_4px_16px_rgba(0,0,0,0.01)] text-left">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        <span className="font-extrabold text-[14px] text-[#1A1A1A] leading-tight">You both owe each other</span>
        <span className="text-[12px] text-[#6B6B6B] font-medium mt-0.5 leading-snug">
      ...
      <button
        ...
        className="shrink-0 px-4 py-2.5 rounded-full bg-positive text-white text-[13px] font-extrabold cursor-pointer hover:opacity-90 active:scale-[0.98] transition-all outline-none border-0"
      >
